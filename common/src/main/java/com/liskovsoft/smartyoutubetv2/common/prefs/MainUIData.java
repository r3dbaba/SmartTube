...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    public static final long MENU_ITEM_CLEAR_PLAYBACK_QUEUE = 1L << 39;
    ...
    public static final long MENU_ITEM_DEFAULT = MENU_ITEM_PIN_TO_SIDEBAR | MENU_ITEM_NOT_INTERESTED | MENU_ITEM_NOT_RECOMMEND_CHANNEL
            ...
            | MENU_ITEM_SUBSCRIBE | MENU_ITEM_CLEAR_HISTORY | MENU_ITEM_CLEAR_PLAYBACK_QUEUE;
    private static final Long[] MENU_ITEM_DEFAULT_ORDER = {
            ...
            MENU_ITEM_CLEAR_PLAYBACK_QUEUE, MENU_ITEM_SHOW_QUEUE, MENU_ITEM_OPEN_CHANNEL, MENU_ITEM_OPEN_PLAYLIST, MENU_ITEM_SUBSCRIBE,
            MENU_ITEM_EXCLUDE_FROM_CONTENT_BLOCK, MENU_ITEM_PIN_TO_SIDEBAR, MENU_ITEM_SAVE_REMOVE_PLAYLIST, MENU_ITEM_OPEN_DESCRIPTION, MENU_ITEM_OPEN_COMMENTS,
