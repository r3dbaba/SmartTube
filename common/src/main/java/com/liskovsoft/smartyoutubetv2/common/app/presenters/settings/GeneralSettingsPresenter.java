...
public class GeneralSettingsPresenter extends BasePresenter<Void> {
    ...
    private void enableChildMode(boolean enable) {
        ...
        long menuItems = MainUIData.MENU_ITEM_SHOW_QUEUE | MainUIData.MENU_ITEM_ADD_TO_QUEUE | MainUIData.MENU_ITEM_PLAY_NEXT | MainUIData.MENU_ITEM_CLEAR_PLAYBACK_QUEUE |
    ...
    private Map<Long, Integer> getMenuNames() {
        ...
        menuNames.put(MainUIData.MENU_ITEM_CLEAR_PLAYBACK_QUEUE, R.string.clear_playback_queue);
